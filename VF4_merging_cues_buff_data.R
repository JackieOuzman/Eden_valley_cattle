...
ggplot() +
  geom_sf(data = eden_valley, color = "black", fill = NA) +
  geom_sf(data = fence4, color = "green", fill = NA)+
  geom_sf(data = sp_VF4_Audio_clip_animalID)
#bring in the buffer
...
#buffer Clip
sp_VF4_Audio_clip_animalID_buff <- st_intersection(sp_VF4_Audio_clip_animalID, fence4_buff)
ggplot() +
  geom_sf(data = eden_valley, color = "black", fill = NA) +
  geom_sf(data = fence4, color = "green", fill = NA)+
  geom_sf(data = sp_VF4_Audio_clip_animalID_buff)

##########       Final output here is  sp_VF4_Audio_clip_animalID_buff                        ####################
st_write(sp_VF4_Audio_clip_animalID_buff, "sp_VF4_Audio_clip_animalID_buff.csv", layer_options = "GEOMETRY=AS_XY")

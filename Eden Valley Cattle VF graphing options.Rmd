...
Inclusion_week1_positive1$day <- as.factor(Inclusion_week1_positive1$day)

ggplot(Inclusion_week1_positive1, aes(x = day, y = count))+
  geom_point()+
  ...
  labs(title= "Week1",
       x= "Day",
       y = "Counts of events inside exclusion zone")

...
```{r inspect data to view quaility day1, echo=FALSE}
...
```
```{r inspect data to view quaility day2, echo=FALSE}
...
```{r filter postive values and summaries with plots1}
...
summary(Inclusion_20_21_05_2019$time)

Inclusion_week1 <- filter(Check_df_VF_week1_2_3_InclusionBord_c_animalID, 

...
saveRDS(VF_week1_2_3_InclusionBord,  paste0("W:/VF/Eden_Valley/logged_VF_data/download2_R_output/","VF_week1_2_3_InclusionBord.rds"))
...
saveRDS(df_VF_week1_2_3_InclusionBord_c_animalID,  paste0("W:/VF/Eden_Valley/logged_VF_data/download2_R_output/","df_VF_week1_2_3_InclusionBord_c_animalID.rds"))
```
...
#summary(Check_df_VF_week1_2_3_InclusionBord_c_animalID)
 ...
 saveRDS(Check_df_VF_week1_2_3_InclusionBord_c_animalID,  paste0("W:/VF/Eden_Valley/logged_VF_data/download2_R_output/","df_VF_week1_2_3_InclusionBord_c_animalID_clean.rds"))                                             
...
More jobs for this dataset.
Bring in the audio and stimulation data.
This should have a date/time clm and collar number the value is coded as TRUE I think?
should also have a GPS point.
This should just be appened to the bottom of my data set.

the below animation code should be moved the the graphing options markdown document.

I alos need to bring in the last weeks of data 
work out if this will run faster on peracry and how I go about doing that.

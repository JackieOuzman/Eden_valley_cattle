...
#arrange by time
sp_VF1_InclusionBord_animalID <- arrange(sp_VF1_InclusionBord_animalID, animal_ID, time )
...
sp_VF1_InclusionBord_animalID <- fill(sp_VF1_InclusionBord_animalID, start_end, .direction = "down")
head(sp_VF1_InclusionBord_animalID)
#check that the fill function has worked
table(sp_VF1_InclusionBord_animalID$start_end_no_fill)
table(sp_VF1_InclusionBord_animalID$start_end)


#need to code my na as other I need as na for the fill function above
sp_VF1_InclusionBord_animalID$start_end <- replace_na(sp_VF1_InclusionBord_animalID$start_end, "temp")
...
#tidy up
head(sp_VF1_InclusionBord_animalID)
sp_VF1_InclusionBord_animalID <- select(sp_VF1_InclusionBord_animalID,
...
table(sp_VF1_InclusionBord_animalID$event)
with(sp_VF1_InclusionBord_animalID,table(event,non_graz)) 
##########################################################################################################################
...
sp_VF1_InclusionBord_animalID <-  group_by(sp_VF1_InclusionBord_animalID, animal_ID, start_end_no_fill) %>% 
  mutate(Index=1:n())  
...
sp_VF1_InclusionBord_animalID <- data.frame(ungroup(sp_VF1_InclusionBord_animalID) )

sp_VF1_InclusionBord_animalID <- arrange(sp_VF1_InclusionBord_animalID, animal_ID, time )

sp_VF1_InclusionBord_animalID <- fill(sp_VF1_InclusionBord_animalID, index_start, .direction = "down")
...
#check 
with(sp_VF1_InclusionBord_animalID,table(event,index_start))
table(sp_VF1_InclusionBord_animalID$index_start)
summary(sp_VF1_InclusionBord_animalID$index_start)
check <- filter(sp_VF1_InclusionBord_animalID, event_number == "-999")
check2 <- filter(sp_VF1_InclusionBord_animalID, event_number != "-999") #no na here
...
event_sum <- filter(VF1_InclusionBord_animalID_sub, event_number != "NA") %>% 

...
```{r plot the audio data merge data explore data per day}
head(VF1_2_3_4buff_cue_animalID_by_cue_date_audio)
head(VF1_2_3_4buff_cue_animalID_by_cue_date_pulse)

VF1_2_3_4buff_cue_animalID_by_cue_date_audio_temp <- mutate(VF1_2_3_4buff_cue_animalID_by_cue_date_audio,
                                                            audio = count,
                                                            pulse = "NA")

head(VF1_2_3_4buff_cue_animalID_by_cue_date_audio_temp)
VF1_2_3_4buff_cue_animalID_by_cue_date_pulse_temp <- mutate(VF1_2_3_4buff_cue_animalID_by_cue_date_pulse,
                                                            audio = "NA",
                                                            pulse = count)
head(VF1_2_3_4buff_cue_animalID_by_cue_date_pulse_temp)

VF1_2_3_4buff_cue_animalID_by_cue_date_audioPulse_temp <- rbind(VF1_2_3_4buff_cue_animalID_by_cue_date_audio_temp,
                                                                VF1_2_3_4buff_cue_animalID_by_cue_date_pulse_temp)
head(VF1_2_3_4buff_cue_animalID_by_cue_date_audioPulse_temp)
...
#can I change the date to a factor and then create a box plot?
Aduio_pulse_sum1$date_factor <- factor(Aduio_pulse_sum1$date)
table(Aduio_pulse_sum1$date_factor)


### Audio This is not working atm
filter(Aduio_pulse_sum1, count <50 & audio_pulse_started == "Audio") %>% 
  geom_boxplot(alpha = 0.2)+
  geom_point()+
  theme_bw()+
  #facet_wrap(. ~ animal_ID)+
